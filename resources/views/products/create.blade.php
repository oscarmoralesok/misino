                    ...
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input type="number" name="base_price" id="base_price" step="0.01" value="{{ old('base_price') }}" class="block w-full rounded-md border-gray-300 pl-7 focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600" placeholder="0.00" required>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600">{{ old('description') }}</textarea>
