<aside class="hidden w-64 overflow-y-auto bg-gray-100 border-r border-gray-100 md:block flex-shrink-0">
    ...
    <div class="p-4 space-y-2">
        ...
        <x-nav-link :href="route('logistics.index')" :active="request()->routeIs('logistics.*')" class="w-full flex items-center px-4 py-3 rounded-full transition-colors duration-200 {{ request()->routeIs('logistics.*') ? 'bg-white text-teal-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
