<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 md:hidden">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('events.index', ['status' => 'pending'])" :active="request()->fullUrlIs(route('events.index', ['status' => 'pending']))">
                {{ __('Pendientes') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('events.index', ['status' => 'confirmed'])" :active="request()->fullUrlIs(route('events.index', ['status' => 'confirmed']))">
                {{ __('Confirmados') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('event-types.index')" :active="request()->routeIs('event-types.*')">
                {{ __('Tipos de Evento') }}
            </x-responsive-nav-link>
        </div>
